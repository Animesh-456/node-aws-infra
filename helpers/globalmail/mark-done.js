const markDone = (fname, id, title, description, assignedTo) => {
    const subject = "Your Task has been marked done by the Employee"
  ...
  <body>
    <div class="container">
      ...
      <h3>Hello, ${fname}</h3>
      <h3>Your task has been marked done by ${assignedTo}</h3>
      <h3>Details of the task:</h3>
      <ul>
      <li><strong>Id : </strong>${id}</li>
      <li><strong>Employee Name : </strong>${assignedTo}</li>
